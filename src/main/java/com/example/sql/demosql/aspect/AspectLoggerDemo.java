package com.example.sql.demosql.aspect;
...
@Aspect
@Component
public class AspectLoggerDemo {
    private static final Logger logger = LoggerFactory.getLogger(AspectLoggerDemo.class);


    @Around("execution(* com.example.sql.demosql.*.*.*(..))")
